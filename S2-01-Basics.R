...
setwd("~/GitHub/mapfre_r_introductory_course")
...
# Quick list of useful R packages: https://tomaztsql.wordpress.com/2020/04/27/essential-list-of-useful-r-packages-for-data-scientists/
...
y <- as.POSIXct("2021-01-01 01:00:00", tz = "US/Pacific")
